...
<div id="page" class="site">
        ...
        <a class="skip-link screen-reader-text"
           href="#content"><?php esc_html_e('Skip to content', 'daily-magazine'); ?></a>
    <div class="header-layout-2">
        ...
        if ((has_nav_menu('em-top-nav')) || (has_nav_menu('em-social-nav'))):
            ...
            <?php do_action('elegant_magazine_action_ticker_news'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="site-advertisement col-md-7 col-sm-7">
                                <?php do_action('elegant_magazine_action_banner_advertisement'); ?>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="navigation-container">
                                ...
                                <span class="screen-reader-text"><?php esc_html_e('Primary Menu', 'daily-magazine'); ?></span>
                                 <i class="ham"></i>
                            </span>
                                <?php
                                wp_nav_menu(array(
