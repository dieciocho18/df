		...
		<?php else : ?>
			...
			?>
				<header class="entry-header">
					<h1 class="entry-title"><?php esc_html_e( 'No posts to display', 'bmag' ); ?></h1>
				</header>

				<div class="entry-content">
					<p><?php printf( __( 'Ready to publish your first post? <a href="%s">Get started here</a>.', 'bmag' ), admin_url( 'post-new.php' ) ); ?></p>
				</div><!-- .entry-content -->
